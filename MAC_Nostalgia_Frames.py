...
if getattr(sys, 'frozen', False):
    # If the application is running in a bundle, the PyInstaller bootloader
...
class RetrogamingOverlayApp:
    def __init__(self, root):
        ...
        icon_path = os.path.join(application_path, 'image0.icns')
    ...
    def load_systems_from_csv(self):
        ...
        csv_path = os.path.join(application_path, 'Resolutions integer scaling.csv')
    ...
    def add_row_to_csv(self):
        ...
        def save_new_row():
            ...
            # Append to CSV file
            # Use 'csv_path' instead of directly using 'Resolutions integer scaling.csv'
    ...
    def update_csv_file(self):
        # Determine the correct path to the CSV file for reading/writing
        if getattr(sys, 'frozen', False):
            # The application is running in a bundle.
            # Consider using a writable location like the user's home directory.
            writable_path = os.path.expanduser("~")
        else:
            # The application is running in a normal Python environment.
            writable_path = os.path.dirname(os.path.abspath(__file__))

        csv_path = os.path.join(writable_path, 'Resolutions integer scaling.csv')
    ...
    def delete_selected_row(self):
        ...
        # Determine the correct path to the CSV file for writing
        if getattr(sys, 'frozen', False):
            # The application is running in a bundle.
            # Use a writable location like the user's home directory.
            writable_path = os.path.expanduser("~")
        else:
            # The application is running in a normal Python environment.
            writable_path = os.path.dirname(os.path.abspath(__file__))
